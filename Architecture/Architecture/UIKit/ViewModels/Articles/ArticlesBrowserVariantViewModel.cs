...
{
    public class ArticlesBrowserVariantViewModel: BaseViewModel
    {
        ...
        public async Task LoadDataAsync()
        {
            try
            {
                ...
                Articles = new ObservableCollection<ArticleItemViewModel>(UIKitService.GetArticles(6));
                TopArticles = new ObservableCollection<ArticleItemViewModel>(UIKitService.GetArticles(6));
                Categories = new ObservableCollection<CategoryItemViewModel>(UIKitService.GetCategories(6));
            }
            catch (Exception ex)
            {
